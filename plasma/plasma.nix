...

{
  programs.plasma = {
    ...
    configFile = {
      ...
      "katerc"."lspclient"."BlockedServerCommandLines" = "/home/fcharpentier/.nix-profile/bin/clangd -log=error --background-index --limit-results=500 --completion-style=bundled";
